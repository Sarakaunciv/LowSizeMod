...
# ect ################################################################
		AaaaGlobal.id_shovel:
			if AsdaInventory.wood >= AaaaGlobal.recipe_wood_count0 * craft_count and AsdaInventory.stone >= 8 * craft_count:
				AsdaInventory.add_wood(-1 * AaaaGlobal.recipe_wood_count0 * craft_count)
				AsdaInventory.add_stone(-1 * 8 * craft_count)
				AsdaInventory.add_shovel(1 * craft_count)
			else:
				craft_max()
				return
		AaaaGlobal.id_axe:
